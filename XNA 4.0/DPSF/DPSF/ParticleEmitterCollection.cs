...
namespace DPSF
{
    ...
    [Serializable]
#endif
    public sealed class ParticleEmitterCollection
    {
        /// <summary>
        ...
        /// </summary>
        private ReadOnlyCollection<int> _emitterIdsCache = new(new List<int>());
        ...
        {
            bool hadAtLeastOneEmitter = _emitters.Count != 0;
        ...
        public ParticleEmitter this[int id]
        {
            get
            {
                if (_emitters.TryGetValue(id, out ParticleEmitter value))
                    return value;
                else
