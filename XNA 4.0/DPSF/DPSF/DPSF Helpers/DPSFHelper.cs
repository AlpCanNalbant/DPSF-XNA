...
namespace DPSF
{
    ...
    public static class DPSFHelper
    {
        ...
        /// </summary>
        public static RandomNumbers RandomNumber => _randomNumber;
        private static readonly RandomNumbers _randomNumber = new();
        ...
        //     {
#if (WIN_RT)
				=> typeof(DPSF<DPSFParticle, DefaultNoDisplayParticleVertex>).GetTypeInfo().Assembly.GetName().Version.ToString();
#else
        ...
        public static bool IsRunningInDebugModeWithDebuggerAttached
        	=> IsRunningInDebugMode && System.Diagnostics.Debugger.IsAttached;
        ...
        public static float RandomNumberBetween(float fValue1, float fValue2)
            => RandomNumber.Between(fValue1, fValue2);
        ...
        // {
            ...
            => (byte)((fNormalizedElapsedTime * (1 - fNormalizedElapsedTime) * (1 - fNormalizedElapsedTime) * 6.7) * 255);
        // }
        ...
        {
            var sRandomVector = new Vector3(RandomNumber.Between(-1.0f, 1.0f), RandomNumber.Between(-1.0f, 1.0f), RandomNumber.Between(-1.0f, 1.0f));
        ...
        public static Vector3 RandomVectorBetweenTwoVectors(Vector3 sVector1, Vector3 sVector2)
            => new(RandomNumber.Between(sVector1.X, sVector2.X),
        ...
        public static Color RandomColor()
            => new(RandomNumber.NextFloat(), RandomNumber.NextFloat(), RandomNumber.NextFloat());
        ...
        public static Color RandomColorWithRandomTransparency()
            => new(RandomNumber.NextFloat(), RandomNumber.NextFloat(), RandomNumber.NextFloat(), RandomNumber.NextFloat());
        ...
        public static Color LerpColor(Color sColor1, Color sColor2, float fInterpolationAmount)
            => LerpColor(sColor1, sColor2, fInterpolationAmount, fInterpolationAmount, fInterpolationAmount, fInterpolationAmount);
        ...
        public static Vector2 RandomPointOnCircle()
            => PointOnCircle(RandomNumber.Between(0, MathHelper.TwoPi));
        ...
        public static Vector3 NormalizedPointOnSphere(float fYawAngle, float fPitchAngle)
            => PivotPoint3D.RotatePosition(Matrix.CreateFromYawPitchRoll(fYawAngle, fPitchAngle, 0), Vector3.Zero, Vector3.Forward);
        ...
        public static Vector3 RandomNormalizedPointOnSphere()
            => NormalizedPointOnSphere(RandomNumber.Between(0, MathHelper.TwoPi), RandomNumber.Between(0, MathHelper.TwoPi));
        ...
        public static Vector3 PointOnSphere(float fYawAngle, float fPitchAngle, float fRadius)
            => (NormalizedPointOnSphere(fYawAngle, fPitchAngle) * fRadius);
        ...
        public static Vector3 RandomPointOnSphere(float fRadius)
            => PointOnSphere(RandomNumber.Between(0, MathHelper.TwoPi), RandomNumber.Between(0, MathHelper.TwoPi), fRadius);
        ...
        public static Vector3 PointOnSphere(float fYawAngle, float fPitchAngle, float fRadius, Vector3 sSpherePosition)
            => PointOnSphere(fYawAngle, fPitchAngle, fRadius) + sSpherePosition;
        ...
        public static Vector3 RandomPointOnSphere(float fRadius, Vector3 sSpherePosition)
            => PointOnSphere(RandomNumber.Between(0, MathHelper.TwoPi), RandomNumber.Between(0, MathHelper.TwoPi), fRadius, sSpherePosition);
        ...
        public static BlendState CloneBlendState(BlendState blendStateToClone)
            => new()
            {
                AlphaBlendFunction = blendStateToClone.AlphaBlendFunction,
                AlphaDestinationBlend = blendStateToClone.AlphaDestinationBlend,
                AlphaSourceBlend = blendStateToClone.AlphaSourceBlend,
                BlendFactor = blendStateToClone.BlendFactor,
                ColorBlendFunction = blendStateToClone.ColorBlendFunction,
                ColorDestinationBlend = blendStateToClone.ColorDestinationBlend,
                ColorSourceBlend = blendStateToClone.ColorSourceBlend,
                ColorWriteChannels = blendStateToClone.ColorWriteChannels,
                ColorWriteChannels1 = blendStateToClone.ColorWriteChannels1,
                ColorWriteChannels2 = blendStateToClone.ColorWriteChannels2,
                ColorWriteChannels3 = blendStateToClone.ColorWriteChannels3,
                MultiSampleMask = blendStateToClone.MultiSampleMask,
                Name = blendStateToClone.Name,
                Tag = blendStateToClone.Tag
            };
        ...
        public static DepthStencilState CloneDepthStencilState(DepthStencilState depthStencilStateToClone)
            => new()
            {
                CounterClockwiseStencilFail = depthStencilStateToClone.CounterClockwiseStencilFail,
                CounterClockwiseStencilDepthBufferFail = depthStencilStateToClone.CounterClockwiseStencilDepthBufferFail,
                CounterClockwiseStencilFunction = depthStencilStateToClone.CounterClockwiseStencilFunction,
                CounterClockwiseStencilPass = depthStencilStateToClone.CounterClockwiseStencilPass,
                DepthBufferEnable = depthStencilStateToClone.DepthBufferEnable,
                DepthBufferFunction = depthStencilStateToClone.DepthBufferFunction,
                DepthBufferWriteEnable = depthStencilStateToClone.DepthBufferWriteEnable,
                Name = depthStencilStateToClone.Name,
                ReferenceStencil = depthStencilStateToClone.ReferenceStencil,
                StencilDepthBufferFail = depthStencilStateToClone.StencilDepthBufferFail,
                StencilEnable = depthStencilStateToClone.StencilEnable,
                StencilFail = depthStencilStateToClone.StencilFail,
                StencilFunction = depthStencilStateToClone.StencilFunction,
                StencilMask = depthStencilStateToClone.StencilMask,
                StencilPass = depthStencilStateToClone.StencilPass,
                StencilWriteMask = depthStencilStateToClone.StencilWriteMask,
                Tag = depthStencilStateToClone.Tag,
                TwoSidedStencilMode = depthStencilStateToClone.TwoSidedStencilMode
            };
        ...
        public static RasterizerState CloneRasterizerState(RasterizerState rasterizerStateToClone)
            => new()
            {
                CullMode = rasterizerStateToClone.CullMode,
                DepthBias = rasterizerStateToClone.DepthBias,
                FillMode = rasterizerStateToClone.FillMode,
                MultiSampleAntiAlias = rasterizerStateToClone.MultiSampleAntiAlias,
                Name = rasterizerStateToClone.Name,
                ScissorTestEnable = rasterizerStateToClone.ScissorTestEnable,
                SlopeScaleDepthBias = rasterizerStateToClone.SlopeScaleDepthBias,
                Tag = rasterizerStateToClone.Tag
            };
        ...
        public static SamplerState CloneSamplerState(SamplerState samplerStateToClone)
            => new()
            {
                AddressU = samplerStateToClone.AddressU,
                AddressV = samplerStateToClone.AddressV,
                AddressW = samplerStateToClone.AddressW,
                Filter = samplerStateToClone.Filter,
                MaxAnisotropy = samplerStateToClone.MaxAnisotropy,
                MaxMipLevel = samplerStateToClone.MaxMipLevel,
                MipMapLevelOfDetailBias = samplerStateToClone.MipMapLevelOfDetailBias,
                Name = samplerStateToClone.Name,
                Tag = samplerStateToClone.Tag
            };
    }
}
