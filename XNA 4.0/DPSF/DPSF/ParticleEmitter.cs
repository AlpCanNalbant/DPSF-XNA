...
namespace DPSF
{
    ...
    public sealed class ParticleEmitter
    {
        ...
        private readonly Position3D _positionData = null;
        private readonly Orientation3D _orientationData = null;
        ...
        public int BurstParticles
        {
            ...
            set
            {
                ...
                if (value <= 0)
                {
                    ...
                    BurstComplete?.Invoke(this, null);
                }
                else
                {
        ...
        private int CalculateHowManyParticlesToEmit(float fElapsedTimeInSeconds)
        {
            ...
            int iNumberOfParticlesToEmit = (int)Math.Floor(fNumberOfParticlesToEmit);
