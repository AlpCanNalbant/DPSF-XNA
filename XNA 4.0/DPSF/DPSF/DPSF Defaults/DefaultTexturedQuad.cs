...
namespace DPSF
{
    ...
    [Serializable]
#endif
    public abstract class DefaultTexturedQuadParticleSystem(Game cGame)
        : DPSFDefaultTexturedQuadParticleSystem<DefaultTexturedQuadParticle, DefaultTexturedQuadParticleVertex>(cGame)
    { }
    ...
    [Serializable]
#endif
    public abstract class DPSFDefaultTexturedQuadParticleSystem<Particle, Vertex>(Game cGame)
        : DPSFDefaultQuadParticleSystem<Particle, Vertex>(cGame)
            ...
            where Vertex : struct, IDPSFParticleVertex
    {
        ...
        {
            if (this.Effect is not AlphaTestEffect effect) return;
