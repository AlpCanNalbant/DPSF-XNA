...
namespace DPSF
{
    ...
    [Serializable]
#endif
	public abstract class DefaultAnimatedSpriteParticleSystem(Game cGame) : DPSFDefaultAnimatedSpriteParticleSystem<DefaultAnimatedSpriteParticle, DefaultSpriteParticleVertex>(cGame)
	{
    }
    ...
    [Serializable]
#endif
	public abstract class DPSFDefaultAnimatedSpriteParticleSystem<Particle, Vertex>(Game cGame) : DPSFDefaultSpriteTextureCoordinatesParticleSystem<Particle, Vertex>(cGame)
