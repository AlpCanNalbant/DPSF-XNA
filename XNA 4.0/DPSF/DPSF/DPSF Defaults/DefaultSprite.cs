...
namespace DPSF
{
    ...
    [Serializable]
#endif
    public abstract class DefaultSpriteParticleSystem(Game cGame)
        : DPSFDefaultSpriteParticleSystem<DefaultSpriteParticle, DefaultSpriteParticleVertex>(cGame)
    { }
    ...
    [Serializable]
#endif
    public abstract class DPSFDefaultSpriteParticleSystem<Particle, Vertex>(Game cGame)
        : DPSFDefaultBaseParticleSystem<Particle, Vertex>(cGame)
        ...
        where Vertex : struct, IDPSFParticleVertex
    {
        ...
        public override void InitializeParticleUsingInitialProperties(DPSFParticle Particle)
        {
            ...
            cParticle.StartWidth = DPSFHelper.RandomNumberBetween(mcInitialProperties.StartSizeMin > 0f ? mcInitialProperties.StartSizeMin : mcInitialProperties.StartWidthMin, mcInitialProperties.StartSizeMax > 0f ? mcInitialProperties.StartSizeMax : mcInitialProperties.StartWidthMax);
            cParticle.EndWidth = DPSFHelper.RandomNumberBetween(mcInitialProperties.EndSizeMin > 0f ? mcInitialProperties.EndSizeMin : mcInitialProperties.EndWidthMin, mcInitialProperties.EndSizeMax > 0f ? mcInitialProperties.EndSizeMax : mcInitialProperties.EndWidthMax);
            cParticle.StartHeight = DPSFHelper.RandomNumberBetween(mcInitialProperties.StartSizeMin > 0f ? mcInitialProperties.StartSizeMin : mcInitialProperties.StartHeightMin, mcInitialProperties.StartSizeMax > 0f ? mcInitialProperties.StartSizeMax : mcInitialProperties.StartHeightMax);
            cParticle.EndHeight = DPSFHelper.RandomNumberBetween(mcInitialProperties.EndSizeMin > 0f ? mcInitialProperties.EndSizeMin : mcInitialProperties.EndHeightMin, mcInitialProperties.EndSizeMax > 0f ? mcInitialProperties.EndSizeMax : mcInitialProperties.EndHeightMax);
    ...
    public struct DefaultSpriteParticleVertex : IDPSFParticleVertex
    {
        ...
        /// </summary>
        public readonly VertexDeclaration VertexDeclaration => null;
    }
}
